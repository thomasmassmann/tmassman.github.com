...
:summary: Sometimes it might be necessary to move a Plone instance to another
          host. This article describes how do this without almost any downtime.
:category: Hosting
:tags: Nginx, Plone

At `Propertyshelf <http://propertyshelf.com>`_ we're hosting a lot of Plone sites. Therefor we
